                ...
                0 => {
                    if (p < n) switch (src[p]) {
                        ...
                        '<' => {
                            p += 1;
                            self.pos = @intCast(p);
                            return .{ .cat = .@"langle", .pre = pre, .pos = @intCast(start), .len = @intCast(p - start) };
                        },
                        '=' => {
                            p += 1;
                            self.pos = @intCast(p);
                        ...
                        '>' => {
                            p += 1;
                            self.pos = @intCast(p);
                            return .{ .cat = .@"rangle", .pre = pre, .pos = @intCast(start), .len = @intCast(p - start) };
                        },
                        '?' => {
                            p += 1;
                            self.pos = @intCast(p);
                ...
                33 => {
                    if (p < n) switch (src[p]) {
                        '.' => {
                            p += 1;
                            self.pos = @intCast(p);
                            return .{ .cat = .@"dots", .pre = pre, .pos = @intCast(start), .len = @intCast(p - start) };
                        },
                        else => {},
                    };
                    break :dfa;
...
const ruleLen = [_]u8{ 2, 2, 2, 2, 1, 0, 1, 1, 4, 4, 3, 6, 4, 3, 3, 5, 3, 1, 2, 1, 2, 2, 2, 2, 1, 0, 3, 2, 2, 2, 2, 1, 3, 3, 3, 2, 2, 1, 1, 3, 2, 2, 1, 1, 3, 1, 2, 2, 2, 2, 1, 4, 3, 1, 4, 3, 2, 0, 2, 1, 2, 1, 3, 4, 4, 2, 2, 1, 2, 0, 2, 3, 2, 2, 1, 1, 4, 1, 1, 2, 2, 3, 3, 2, 1, 4, 3, 2, 1, 1, 1, 3, 1, 2, 1, 1, 1, 1, 2 };
